...
public class AngleSnapScreen extends Screen {
    ...
    protected AngleSnapScreen(Screen parent) {
        super(Component.translatable("anglesnap.gui.screen.title"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new AngleSnapListWidget(this.minecraft, this.width, this.height - 70, 35, this));
            ...
            if (AngleSnap.isInMultiplayer() && !AngleSnap.CONFIG.disableMultiplayerWarning.getValue()) {
                return AngleSnapWarningScreen.create(
                        disableMultiplayerWarning -> {
                            ...
                            Minecraft.getInstance().setScreen(new AngleSnapScreen(parent));
                        },
